...
router.get('/issue', function(req, res){
	...
	{
		_enddate = newdate.getFullYear()+"-"+newdate.getMonth()+"-"+newdate.getDate()+"T23:59:59:000Z";
	}
	else{
  ...
  if(_coordinates === ''){
	  if( _issue === '')
	  {
		  ...
		  Issue.find({"create_at":{$gte:ISODate("2016-2-28T00:00:00:000Z"), $lt:ISODate("2016-2-31T23:59:59:000Z")}
							},function(err, issue){
			res.send(issue);
